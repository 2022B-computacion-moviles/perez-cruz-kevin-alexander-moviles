package com.example.deber02.activity
...
import com.example.deber02.databinding.ActivityOtpactivityBinding
...
class OTPActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val phoneNumber = "+593"+intent.getStringExtra("number")
        ...
        val options = PhoneAuthOptions.newBuilder(auth)
            ...
            .setCallbacks(object : OnVerificationStateChangedCallbacks(){
                ...
                override fun onVerificationFailed(p0: FirebaseException) {
                    dialog.dismiss()
                    Toast.makeText(this@OTPActivity, "Por favor, intenta de nuevo.", Toast.LENGTH_SHORT).show()
                }
